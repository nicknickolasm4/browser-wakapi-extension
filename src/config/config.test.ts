    ...
    expect(config).toMatchInlineSnapshot(`
      {
        ...
        "currentUserApiEndPoint": "/compat/wakatime/v1/users/current",
        ...
        "heartbeatApiEndPoint": "/compat/wakatime/v1/users/current/heartbeats",
        "hostname": "",
        "loggingEnabled": true,
        "loggingStyle": "blacklist",
        "loggingType": "domain",
        "logoutUserUrl": "https://wakapi.dev/logout",
        "name": "WakaApi",
        "nonTrackableSites": [
          "chrome://",
          "about:",
        ...
        "summariesApiEndPoint": "/compat/wakatime/v1/users/current/summaries",
        "theme": "light",
        "tooltips": {
          "allGood": "",
